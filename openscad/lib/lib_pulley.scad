...
module gt2_pulley(teeth, motor_shaft, pulley_t_ht=6, pulley_b_ht=6, pulley_b_dia=30, no_of_nuts=3, nut_shaft_distance=3) {
    ...
    nut_angle = 360 / no_of_nuts;		// angle between nuts, standard = 90
